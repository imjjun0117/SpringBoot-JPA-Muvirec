						...
						<div class="row justify-content-center">
							<div class="col-lg-5">
								<div class="card shadow-lg border-0 rounded-lg mt-5">
									...
									<c:choose>
										<c:when test="${principal.user.oauth eq 'oauth' }">
											<div class="form-floating mb-3">
												<input class="form-control" id="username" type="text" name="username" value="${principal.user.username }"readonly/> <label for="inputUsername">User Name</label>
											</div>
											<div class="form-floating mb-3">
												<input class="form-control" id="email" type="email" name="email" value="${principal.user.email }" readonly/> <label for="inputEmail">email</label>
											</div>
										</c:when>
										<c:otherwise>
											<div class="form-floating mb-3">
